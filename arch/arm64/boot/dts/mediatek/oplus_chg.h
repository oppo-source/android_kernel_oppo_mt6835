...
#define OPLUS_IC_FUNC_CP_SET_PMID2VOUT_OVP_ENABLE	(OPLUS_IC_FUNC_NUM_CP_START + 21)
...
#define OPLUS_IC_FUNC_GAUGE_SET_FAST_SAMPLING		(OPLUS_IC_FUNC_NUM_GAUGE2_START + 11)
#define OPLUS_IC_FUNC_GAUGE_CHECK_IMP_MODEL		(OPLUS_IC_FUNC_NUM_GAUGE2_START + 12)
