...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xde, 0x01);
	lcm_dcs_write_seq_static(ctx, 0xb7, 0x32, 0x0f, 0xd2, 0xd6, 0xdb, 0xdf, 0xe2, 0xe3, 0xe4, 0xef, 0xfb, 0xa0, 0xb0, 0xb0, 0xb0, 0xb0, 0xb0, 0xb1, 0xd6,
	0xe0, 0xa6, 0xa6, 0xa6, 0xa6, 0xa7, 0xa8, 0xa9, 0xdc, 0xde, 0x66, 0xc0, 0x80, 0x66);
	lcm_dcs_write_seq_static(ctx, 0xbf, 0x00, 0x0c);
	lcm_dcs_write_seq_static(ctx, 0xde, 0x02);
	lcm_dcs_write_seq_static(ctx, 0xe6, 0x14, 0x47, 0x24, 0x00, 0x00, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xe9, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xec, 0x07, 0x07, 0x60, 0x00);
	lcm_dcs_write_seq_static(ctx, 0xd2, 0x02, 0xff, 0xf0, 0xc8, 0xb0, 0x9e, 0x92);
	lcm_dcs_write_seq_static(ctx, 0xde, 0x00);
