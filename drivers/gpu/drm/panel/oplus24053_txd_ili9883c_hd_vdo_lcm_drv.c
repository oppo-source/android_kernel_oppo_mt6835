...
** File: oplus24053_txd_ili9883c_hd_vdo_lcm_drv.c
** Description: source file for lcm oplus24053_txd_ili9883c_hd_vdo_lcm_drv in kernel stage
**
** Version: 1.0
** Date: 2023/12/29
** Author: display.lcd
...
**       display        2023/12/29      1.0              source file for lcm oplus24053_txd_ili9883c_hd_vdo_lcm_drv in kernel stage
**
****************************************************************/
...
#include "../mediatek/mediatek_v2/mtk_corner_pattern/oplus24053_txd_ili9883c_data_hw_roundedpattern.h"
#endif
#include "oplus24053_txd_ili9883c_hd_vdo_lcm_drv.h"
#include "../bias/oplus23661_aw37501_bias.h"
#include <linux/reboot.h>

#define MAX_NORMAL_BRIGHTNESS    (3310)
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	pr_info("%s: oplus24053_txd_ili9883c_hd_vdo_lcm_drv  lcm ctx->prepared %d\n", __func__, ctx->prepared);
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	pr_err("[TP] oplus24053_txd_ili9883c_hd_vdo_lcm_drv g_shutdown_flag is %d, esd_flag is %d\n", g_shutdown_flag, esd_flag);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "ili9883c_hd_vdo_lcm_drv", "oplus24053_txd");
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus24053,txd,ili9883c,hd,vdo,lcm,drv", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus24053_txd_ili9883c_hd_vdo_lcm_drv",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("ili9883c_txd_ab5_vdo_lcm_drv Panel Driver");
