...
static void jdi_panel_init(struct jdi *ctx)
{
        ...
        jdi_dcs_write_seq_static(ctx, 0x0C, 0x3C);
        jdi_dcs_write_seq_static(ctx, 0x0D, 0x3C);
        ...
        jdi_dcs_write_seq_static(ctx, 0x1A, 0x3C);
        jdi_dcs_write_seq_static(ctx, 0x1B, 0x3C);
