...
** File: oplus_ac321_p_4_a0035_dsi_video_mode_panel.c
** Description: source file for lcm oplus_ac321_p_4_a0035_dsi_video_mode_panel in kernel stage
**
** Version: 1.0
** Date: 2025/07/08
** Author: display.lcd
...
#endif
*/
#include "oplus_ac321_p_4_a0035_dsi_video_mode_panel.h"
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	pr_info("%s: oplus_ac321_p_4_a0035_dsi_video_mode_panel  lcm ctx->prepared %d\n", __func__, ctx->prepared);
...
static void lcm_gamma_enter (void *dsi, dcs_write_gce cb, void *handle)
{
	...
	char bl_tb2[] = {0xE0, 0x55, 0x6E, 0x79, 0x83, 0x94, 0x55, 0xA6, 0xB7, 0xCE,
			 0xE4, 0xAA, 0x0A, 0x2D, 0x51, 0x75, 0xEA, 0x9D, 0xCD, 0xEC,
			 0x12, 0xFF, 0x31, 0x59, 0x89, 0xAF, 0x03, 0xDA};
	char bl_tb3[] = {0xE1, 0x55, 0x6E, 0x79, 0x83, 0x94, 0x55, 0xA6, 0xB7, 0xCE,
			 0xE4, 0xAA, 0x0A, 0x2D, 0x51, 0x75, 0xEA, 0x9D, 0xCD, 0xEC,
			 0x12, 0xFF, 0x31, 0x59, 0x89, 0xAF, 0x03, 0xDA};
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "a0035", "p_4");
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus,ac321,p_4,a0035,dsi,video,mode,panel", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus_ac321_p_4_a0035_dsi_video_mode_panel",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("oplus_ac321_p_4_a0035_dsi_video_mode_panel Panel Driver");
