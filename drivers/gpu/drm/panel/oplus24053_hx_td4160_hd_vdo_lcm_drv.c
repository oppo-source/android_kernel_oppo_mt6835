...
** File: oplus24053_hx_td4160_hd_vdo_lcm_drv.c
** Description: source file for lcm alpha_b5 in kernel stage
**
** Version: 1.0
** Date: 2023/12/29
** Author: display.lcd
...
**       display        2023/12/29      1.0              source file for lcm alpha_b5 in kernel stage
**
****************************************************************/
...
#include "../mediatek/mediatek_v2/mtk_corner_pattern/oplus24053_hx_td4160_data_hw_roundedpattern.h"
#endif
#include "oplus24053_hx_td4160_hd_vdo_lcm_drv.h"
...
static int lcm_unprepare(struct drm_panel *panel)
{
	...
	if (tp_gesture_enable_notifier && tp_gesture_enable_notifier(0) && (g_shutdown_flag == 0)) {
		pr_err("[TP] tp gesture is enable, IRQ not Change \n");
	} else {
		blank = LCD_CTL_IRQ_OFF;
		mtk_disp_notifier_call_chain(MTK_DISP_EVENT_FOR_TOUCH, &blank);
		pr_err("[TP]TP LCD_CTL_IRQ_OFF will chang to off\n");
	}
...
void lcm_gamma_enter(void *dsi, dcs_write_gce cb, void *handle)
{
	char bl_tb0[] = {0xB0, 0x04};
	char bl_tb1[] = {0xC7, 0x02, 0x20, 0x02, 0x29, 0x02, 0x3C, 0x02, 0x4E, 0x02, 0x6F, 0x02, 0x5D, 0x02, 0x12, 0x01, 0xE3, 0x01, 0xC0, \
					0x01, 0xB7, 0x01, 0xB0, 0x01, 0xB1, 0x01, 0xBC, 0x01, 0xB2, 0x01, 0xBF, 0x02, 0x49};
	char bl_tb2[] = {0xF0, 0xC7, 0x20, 0x02};
	char bl_tb3[] = {0xF0, 0xC7, 0x21, 0x7B};
	char bl_tb4[] = {0xF0, 0xC7, 0x22, 0x02};
	char bl_tb5[] = {0xF0, 0xC7, 0x23, 0xE8};
	char bl_tb6[] = {0xF0, 0xC7, 0x24, 0x02};
	char bl_tb7[] = {0xF0, 0xC7, 0x25, 0xFF};
	char bl_tb8[] = {0xF0, 0xC7, 0x26, 0x02};
	char bl_tb9[] = {0xF0, 0xC7, 0x27, 0x20};
	char bl_tb10[] = {0xF0, 0xC7, 0x28, 0x02};
	char bl_tb11[] = {0xF0, 0xC7, 0x29, 0x29};
	char bl_tb12[] = {0xF0, 0xC7, 0x2A, 0x02};
	char bl_tb13[] = {0xF0, 0xC7, 0x2B, 0x3C};
	char bl_tb14[] = {0xF0, 0xC7, 0x2C, 0x02};
	char bl_tb15[] = {0xF0, 0xC7, 0x2D, 0x4E};
	char bl_tb16[] = {0xF0, 0xC7, 0x2E, 0x02};
	char bl_tb17[] = {0xF0, 0xC7, 0x2F, 0x6F};
	char bl_tb18[] = {0xF0, 0xC7, 0x30, 0x02};
	char bl_tb19[] = {0xF0, 0xC7, 0x31, 0x5D};
	char bl_tb20[] = {0xF0, 0xC7, 0x32, 0x02};
	char bl_tb21[] = {0xF0, 0xC7, 0x33, 0x12};
	char bl_tb22[] = {0xF0, 0xC7, 0x34, 0x01};
	char bl_tb23[] = {0xF0, 0xC7, 0x35, 0xE3};
	char bl_tb24[] = {0xF0, 0xC7, 0x36, 0x01};
	char bl_tb25[] = {0xF0, 0xC7, 0x37, 0xC0};
	char bl_tb26[] = {0xF0, 0xC7, 0x38, 0x01};
	char bl_tb27[] = {0xF0, 0xC7, 0x39, 0xB7};
	char bl_tb28[] = {0xF0, 0xC7, 0x3A, 0x01};
	char bl_tb29[] = {0xF0, 0xC7, 0x3B, 0xB0};
	char bl_tb30[] = {0xF0, 0xC7, 0x3C, 0x01};
	char bl_tb31[] = {0xF0, 0xC7, 0x3D, 0xB1};
	char bl_tb32[] = {0xF0, 0xC7, 0x3E, 0x01};
	char bl_tb33[] = {0xF0, 0xC7, 0x3F, 0xBC};
	char bl_tb34[] = {0xF0, 0xC7, 0x40, 0x01};
	char bl_tb35[] = {0xF0, 0xC7, 0x41, 0xB2};
	char bl_tb36[] = {0xF0, 0xC7, 0x42, 0x01};
	char bl_tb37[] = {0xF0, 0xC7, 0x43, 0xBF};
	char bl_tb38[] = {0xF0, 0xC7, 0x44, 0x02};
	char bl_tb39[] = {0xF0, 0xC7, 0x45, 0x49};
	char bl_tb40[] = {0xF0, 0xC7, 0x46, 0x02};
	char bl_tb41[] = {0xF0, 0xC7, 0x47, 0x7B};
	char bl_tb42[] = {0xF0, 0xC7, 0x48, 0x02};
	char bl_tb43[] = {0xF0, 0xC7, 0x49, 0xE8};
...
void lcm_gamma_exit(void *dsi, dcs_write_gce cb, void *handle)
{
	char bl_tb0[] = {0xB0, 0x04};
	char bl_tb1[] = {0xC7, 0x00, 0x6C, 0x00, 0x9B, 0x00, 0xBB, 0x00, 0xF7, 0x01, 0x50, 0x01, 0x7E, 0x01, 0x72, 0x01, 0x7C, 0x01, 0x7C,
					0x01, 0x87, 0x01, 0x8E, 0x01, 0x96, 0x01, 0xA7, 0x01, 0x9E, 0x01, 0xB0, 0x02, 0x37};
	char bl_tb2[] = {0xF0, 0xC7, 0x20, 0x02};
	char bl_tb3[] = {0xF0, 0xC7, 0x21, 0x6F};
	char bl_tb4[] = {0xF0, 0xC7, 0x22, 0x02};
	char bl_tb5[] = {0xF0, 0xC7, 0x23, 0xAF};
	char bl_tb6[] = {0xF0, 0xC7, 0x24, 0x02};
	char bl_tb7[] = {0xF0, 0xC7, 0x25, 0xDB};
	char bl_tb8[] = {0xF0, 0xC7, 0x26, 0x00};
	char bl_tb9[] = {0xF0, 0xC7, 0x27, 0x24};
	char bl_tb10[] = {0xF0, 0xC7, 0x28, 0x00};
	char bl_tb11[] = {0xF0, 0xC7, 0x29, 0x42};
	char bl_tb12[] = {0xF0, 0xC7, 0x2A, 0x00};
	char bl_tb13[] = {0xF0, 0xC7, 0x2B, 0xAF};
	char bl_tb14[] = {0xF0, 0xC7, 0x2C, 0x00};
	char bl_tb15[] = {0xF0, 0xC7, 0x2D, 0xF7};
	char bl_tb16[] = {0xF0, 0xC7, 0x2E, 0x01};
	char bl_tb17[] = {0xF0, 0xC7, 0x2F, 0x50};
	char bl_tb18[] = {0xF0, 0xC7, 0x30, 0x01};
	char bl_tb19[] = {0xF0, 0xC7, 0x31, 0x7E};
	char bl_tb20[] = {0xF0, 0xC7, 0x32, 0x01};
	char bl_tb21[] = {0xF0, 0xC7, 0x33, 0x72};
	char bl_tb22[] = {0xF0, 0xC7, 0x34, 0x01};
	char bl_tb23[] = {0xF0, 0xC7, 0x35, 0x7C};
	char bl_tb24[] = {0xF0, 0xC7, 0x36, 0x01};
	char bl_tb25[] = {0xF0, 0xC7, 0x37, 0x7C};
	char bl_tb26[] = {0xF0, 0xC7, 0x38, 0x01};
	char bl_tb27[] = {0xF0, 0xC7, 0x39, 0x87};
	char bl_tb28[] = {0xF0, 0xC7, 0x3A, 0x01};
	char bl_tb29[] = {0xF0, 0xC7, 0x3B, 0x8E};
	char bl_tb30[] = {0xF0, 0xC7, 0x3C, 0x01};
	char bl_tb31[] = {0xF0, 0xC7, 0x3D, 0x96};
	char bl_tb32[] = {0xF0, 0xC7, 0x3E, 0x01};
	char bl_tb33[] = {0xF0, 0xC7, 0x3F, 0xA7};
	char bl_tb34[] = {0xF0, 0xC7, 0x40, 0x01};
	char bl_tb35[] = {0xF0, 0xC7, 0x41, 0x9E};
	char bl_tb36[] = {0xF0, 0xC7, 0x42, 0x01};
	char bl_tb37[] = {0xF0, 0xC7, 0x43, 0xB0};
	char bl_tb38[] = {0xF0, 0xC7, 0x44, 0x02};
	char bl_tb39[] = {0xF0, 0xC7, 0x45, 0x37};
	char bl_tb40[] = {0xF0, 0xC7, 0x46, 0x02};
	char bl_tb41[] = {0xF0, 0xC7, 0x47, 0x6F};
	char bl_tb42[] = {0xF0, 0xC7, 0x48, 0x02};
	char bl_tb43[] = {0xF0, 0xC7, 0x49, 0x93};
	char bl_tb44[] = {0xF0, 0xC7, 0x4A, 0x02};
	char bl_tb45[] = {0xF0, 0xC7, 0x4B, 0x93};
...
{
	char bl_tb0[] = {0xB0, 0x04};
	char bl_tb1[] = {0xF0, 0xCE, 0x13, 0x04};
	char bl_tb2[] = {0xF0, 0xCE, 0x14, 0x04};
	char bl_tb3[] = {0xF0, 0xCE, 0x15, 0x00};
	char bl_tb4[] = {0x53, 0x2c};
	char bl_tb5[] = {0x28, 0x00};
...
{
	char bl_tb0[] = {0xB0, 0x04};
	char bl_tb1[] = {0xF0, 0xCE, 0x13, 0x00};
	char bl_tb2[] = {0xF0, 0xCE, 0x14, 0x00};
	char bl_tb3[] = {0xF0, 0xCE, 0x15, 0x00};
	char bl_tb4[] = {0x53, 0x2c};
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	if (ctx->prepared)
		return 0;
	pr_info("%s: oplus24053_hx_td4160_hd_vdo_lcm_drv lcm ctx->prepared %d\n", __func__, ctx->prepared);
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	pr_err("[TP] oplus24053_hx_td4160_hd_vdo_lcm_drv g_shutdown_flag is %d, esd_flag is %d\n", g_shutdown_flag, esd_flag);
	if (tp_gesture_enable_notifier && tp_gesture_enable_notifier(0) && (g_shutdown_flag == 0)) {
	...
	if(g_shutdown_flag == 1) {
		...
		pr_err("[TP] g_shutdown_flag ==1, Display goto power off , And TP reset will low\n");
	} else {
...
static void lcm_cabc_mode_switch_to0(void *dsi, dcs_write_gce cb,
		void *handle, unsigned int cabc_mode)
{
	unsigned char cabc_cmd_1[] = {0x55, 0x03};
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "td4160_hd_vdo_lcm_drv", "oplus24053_hx");
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "oplus24053,hx,td4160,hd,vdo,lcm,drv", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oplus24053_hx_td4160_hd_vdo_lcm_drv",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("oplus24053_hx_td4160_hd_vdo_lcm_drv Panel Driver");
