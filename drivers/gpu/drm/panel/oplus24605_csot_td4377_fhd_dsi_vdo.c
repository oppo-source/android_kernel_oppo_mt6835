...
static void jdi_panel_init(struct jdi *ctx)
{
	jdi_dcs_write_seq_static(ctx, 0xB0, 0x04);
        ...
        jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x00, 0x7D);
        jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x01, 0x10);
        jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x02, 0x10);
        ...
        jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x09, 0x69);
        jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x0a, 0x86);
        ...
        jdi_dcs_write_seq_static(ctx, 0xF0, 0xCE, 0x11, 0xbb);
