 ...
 ** OPLUS_EDIT
 ** File: oplus23706_txd_ft8057p_hd_dsi_vdo.h
...
#endif
#include "oplus23706_txd_ft8057p_hd_dsi_vdo.h"
...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0xCA, 0x02, 0x02, 0x0C);
	jdi_dcs_write_seq_static(ctx, 0x00, 0xB5);
	jdi_dcs_write_seq_static(ctx, 0xCA, 0x05);
	jdi_dcs_write_seq_static(ctx, 0x00, 0xA0);
	jdi_dcs_write_seq_static(ctx, 0xCA, 0x08, 0x08, 0x08);
	jdi_dcs_write_seq_static(ctx, 0x00, 0xB1);
	jdi_dcs_write_seq_static(ctx, 0xF5, 0x11);

	jdi_dcs_write_seq_static(ctx, 0x00, 0x80);
	jdi_dcs_write_seq_static(ctx, 0xCA, 0xE5, 0xD3, 0xC2, 0xB4, 0xAB, 0xA1, 0x9A, 0x94, 0x8E, 0x89, 0x85, 0x81);
	jdi_dcs_write_seq_static(ctx, 0x00, 0x90);
	jdi_dcs_write_seq_static(ctx, 0xCA, 0xFE, 0xFF, 0x66, 0xFC, 0xFF, 0xCC, 0xE9, 0x13, 0x99);

	jdi_dcs_write_seq_static(ctx, 0x35, 0x00);
	jdi_dcs_write_seq_static(ctx, 0x53, 0x2C);
	jdi_dcs_write_seq_static(ctx, 0x51, 0x00, 0X00);
	jdi_dcs_write_seq_static(ctx, 0x5E, 0x03, 0X00);
...
#define VAC (1604)
#define HAC (720)
#define VFP_50hz (2975)
#define VFP_60hz (2205)
#define VFP_90hz (922)
#define VFP_120hz (280)
#define PLL_CLOCK (565)
...
static struct mtk_panel_params ext_params_50hz = {
                .pll_clk = PLL_CLOCK,
                .vendor = "ft8057p_barley",
                .manufacture = "23706_txd_ft8057p",
                .cust_esd_check = 1,
                .esd_check_enable = 1,
                ...
                .lcm_esd_check_table[1] = {
                        .cmd = 0xAC, .count = 1, .para_list[0] = 0x00,
                },
                .ssc_enable = 0,
                .bdg_ssc_enable = 0,
                .lane_swap_en = 0,
		...
		void *handle)
{
	...
	bl_tb0[1] = backlight_level_esd >> 4;
	bl_tb0[2] = backlight_level_esd & 0x0F;
	if (!cb)
		return -1;
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
        ...
        pr_info("%s+ jdi_probe enter txd,ft8057p,vdo,120hz\n", __func__);
	...
	register_device_proc("lcd", "ft8057p_barley", "23706_txd_ft8057p");
...
static const struct of_device_id jdi_of_match[] = {
        {
                .compatible = "oplus23706,txd,ft8057p,hd,dsi,vdo",
        },
        {
        }
};
...
static struct mipi_dsi_driver jdi_driver = {
        ...
        .remove = jdi_remove,
        .driver = {
                .name = "oplus23706_txd_ft8057p_hd_dsi_vdo",
                .owner = THIS_MODULE,
...
MODULE_DESCRIPTION("TXD FT8057P VDO 120HZ LCD Panel Driver");
