...
static void jdi_panel_init(struct jdi *ctx)
{
        ...
        jdi_dcs_write_seq_static(ctx, 0x82, 0x15);
        ...
        jdi_dcs_write_seq_static(ctx, 0xB3, 0xE5);
        jdi_dcs_write_seq_static(ctx, 0xA6, 0xE6);
        jdi_dcs_write_seq_static(ctx, 0xAC, 0xFA);
        /*cabc MODE2*/
        jdi_dcs_write_seq_static(ctx, 0xA7, 0xF3);
        ...
        jdi_dcs_write_seq_static(ctx, 0xB4, 0xD9);
        /*cabc MODE3*/
        jdi_dcs_write_seq_static(ctx, 0xA8, 0xD0);
        jdi_dcs_write_seq_static(ctx, 0xAB, 0xDE);
        jdi_dcs_write_seq_static(ctx, 0xAE, 0xC8);
        jdi_dcs_write_seq_static(ctx, 0x96, 0x90);
        jdi_dcs_write_seq_static(ctx, 0x97, 0x92);
        jdi_dcs_write_seq_static(ctx, 0x98, 0x93);
        jdi_dcs_write_seq_static(ctx, 0x99, 0x9B);
        jdi_dcs_write_seq_static(ctx, 0x9A, 0xA3);
        jdi_dcs_write_seq_static(ctx, 0x9B, 0xB6);
        jdi_dcs_write_seq_static(ctx, 0x9C, 0xBD);
        jdi_dcs_write_seq_static(ctx, 0x9D, 0xC6);
        jdi_dcs_write_seq_static(ctx, 0x9E, 0xC6);
        jdi_dcs_write_seq_static(ctx, 0x9F, 0xD8);
        jdi_dcs_write_seq_static(ctx, 0xB5, 0xD0);

        jdi_dcs_write_seq_static(ctx, 0xA0, 0xC0);
        jdi_dcs_write_seq_static(ctx, 0xA1, 0x7E);
        jdi_dcs_write_seq_static(ctx, 0xA2, 0x7E);
        jdi_dcs_write_seq_static(ctx, 0xB6, 0xD0);
        jdi_dcs_write_seq_static(ctx, 0xB7, 0xD6);
        jdi_dcs_write_seq_static(ctx, 0xB8, 0xD5);
        jdi_dcs_write_seq_static(ctx, 0xB1, 0x66);
        jdi_dcs_write_seq_static(ctx, 0xB2, 0x66);
				 ...
				 unsigned int level)
{
	...
	if ((level > 0) && (level < MAX_NORMAL_BRIGHTNESS)) {
        ...
        if (((aod_state == 1) && (level == 1000)) || ((aod_state == 1) && (level == 1003))) {
                aod_state = false;
                return 0;
        }
