...
** File: ili9883c_txd_ab5_vdo_lcm_drv.c
...
#endif
#include "include/ili9883c_txd_ab5_vdo_lcm_drv.h"
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	pr_err("[TP] ili9883c_txd_ab5_vdo_lcm_drv g_shutdown_flag is %d, esd_flag is %d\n", g_shutdown_flag, esd_flag);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "ili9883c_txd_01", "AB5_V01");
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "ili9883c,txd,ab5,vdo,lcm", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "ili9883c_txd_ab5_vdo_lcm_drv",
		.owner = THIS_MODULE,
