...
#define PFX "CAM_CAL_OMEGAC1MAIN"
...
static unsigned int do_lens_id_imx890(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_imx890(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01480126, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001D60, 0x0000074C, do_single_lsc_imx890},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_imx890}, //Start address, block size is useless
		{0x00000001, 0x000024B0, 0x00000A3A, do_pdaf_imx890},
...
struct STRUCT_CAM_CAL_CONFIG_STRUCT omegac1main_op_eeprom = {
	.name = "omegac1main_op_eeprom",
...
#define IMX890_HVBIN_PDAF_PROC1_SIZE  (976)
#define IMX890_HVBIN_PDAF_PROC2_SIZE  (1624)
#define IMX890_HVBIN_PDAF_PROC1_ADDR  (0x24B0)
#define IMX890_HVBIN_PDAF_PROC2_ADDR  (0x2890)

unsigned int do_pdaf_imx890(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
