...
#define AF_DRVNAME "GT9772AF_24031_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GT9772AF_24031_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9772AF_24031_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
...
int GT9772AF_24031_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9772AF_24031_GetFileName(unsigned char *pFileName)
{
