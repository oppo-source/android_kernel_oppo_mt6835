...
/*
 * GT9772AF_ALPHAL5 voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "GT9772AF_ALPHAL5_DRV"
...
/* ////////////////////////////////////////////////////////////// */
long GT9772AF_ALPHAL5_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9772AF_ALPHAL5_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    int Ret = 0;
...
int GT9772AF_ALPHAL5_PowerDown(struct i2c_client *pstAF_I2Cclient,
        int *pAF_Opened)
{
...
int GT9772AF_ALPHAL5_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int GT9772AF_ALPHAL5_GetFileName(unsigned char *pFileName)
{
