...
static int initdrv(void)
{
	...
	{0x02, 0x02}, {0x06, 0x40}, {0x07, 0x46}, {0xFE, 0xFE},
	};
...
/* ////////////////////////////////////////////////////////////// */
long JD5516WE4_Ioctl(struct file *a_pstFile,
...
int JD5516WE4_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
    LOG_INF("Start\n");
...
int JD5516WE4_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int JD5516WE4_GetFileName(unsigned char *pFileName)
{
