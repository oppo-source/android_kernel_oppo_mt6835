...
void gc32e1_24688_read_crosstalk_data(void)
{
	kal_uint16 i = 0;
...
void gc32e1_24688_copy_crosstalk_data(kal_uint8 *ct_data)
{
...
void gc32e1_24688_otp_identify(void)
{
	LOG_INF("start hyper otp_identify");
	gc32e1_24688_read_crosstalk_data();
