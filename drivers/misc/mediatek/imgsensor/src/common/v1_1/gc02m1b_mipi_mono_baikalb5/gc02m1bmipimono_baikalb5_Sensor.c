 ...
 * Filename:
 * ---------
 *     gc02m1bmipimono_baikalb5_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc02m1bmipimono_baikalb5_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1B_SENSOR_ID_BAIKALB5,
...
{
	return (((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + SENSOR_ID_OFFSET_BAIKALB5);
}
