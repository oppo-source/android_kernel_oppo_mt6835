...
#include "s5kjn1mipiraw_23706_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1_SENSOR_ID_23706,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{8160, 6144, 240, 912, 7680, 4320, 3840, 2160, 0, 0, 3840, 2160, 0, 0, 3840, 2160},/* Video */
	{8160, 6144, 240, 912, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080},/*HS_VID SMVR 240FPS 1080P*/
	{8160, 6144, 600, 468, 6960, 5208, 2320, 1736, 0, 0, 2320, 1736, 0, 0, 2320, 1736},/* slim_video 4M 60FPS*/
	{8160, 6144, 0, 0, 8160, 6144, 4080, 3072, 0, 0, 4080, 3072,8, 12, 4064, 3048},/* custom1 stereo as Preview */
	{8160, 6144, 240, 912, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080},/*HS_VID SMVR 120FPS 1080P*/
	{8160, 6144, 0, 0, 8160, 6144, 8160, 6144, 0, 0, 8160, 6144, 0, 0, 8160, 6144},  /*custom3 as full size capture*/
	{8160, 6144, 240, 912, 7680, 4320, 1920, 1080, 0, 0, 1920, 1080, 0, 0, 1920, 1080},   /*custom4 for 60fps 1080P*/
	{8160, 6144, 816, 624, 6528, 4896, 3264, 2448, 0, 0, 3264, 2448, 0, 0, 3264, 2448},/* custom6 stereo as Preview */
};
...
static kal_uint32 return_sensor_id(void)
{
	...
	sensor_id = (((sensor_id_0 << 8) & 0xFF00) | (sensor_id_1 & 0xFF)+1);
			...
			kal_uint16 frame_length, kal_bool auto_extend_en)
{
	...
	write_cmos_sensor(0x0202, shutter);
	//write_cmos_sensor(0x0104, 0x00);
	LOG_INF("S5KJN1_set_shutter_frame_length() shutter =%d, frame_length = %d, dummy_line = %d, auto_extend_en = %d, imgsensor.frame_length =%d\n",
...
// //#ifdef OPLUS_FEATURE_CAMERA_COMMON
static BYTE s5kjn1_barley_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_s5kjn1_barley_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
...
static void read_s5kjn1_barley_module_data(UINT32 sensor_id)
{
// s5kjn1_barley_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
...
// sensorid : [30 ~ 33]
	...
	memset(s5kjn1_barley_common_data, 0,sizeof(s5kjn1_barley_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		s5kjn1_barley_common_data[8 + idx] = read_s5kjn1_barley_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	s5kjn1_barley_common_data[40] = read_s5kjn1_barley_eeprom_module(vcmAddr);
	s5kjn1_barley_common_data[41] = read_s5kjn1_barley_eeprom_module(vcmAddr + 1);
	//lensid
	s5kjn1_barley_common_data[44] = read_s5kjn1_barley_eeprom_module(lensAddr);
	s5kjn1_barley_common_data[45] = read_s5kjn1_barley_eeprom_module(lensAddr + 1);
	//macro
	s5kjn1_barley_common_data[48] = read_s5kjn1_barley_eeprom_module(macAddr_lsb);
	s5kjn1_barley_common_data[49] = read_s5kjn1_barley_eeprom_module(macAddr_msb);
	//inf
	s5kjn1_barley_common_data[52] = read_s5kjn1_barley_eeprom_module(infAddr_lsb);
	s5kjn1_barley_common_data[53] = read_s5kjn1_barley_eeprom_module(infAddr_msb);

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		LOG_INF("cam data: %02x %02x %02x %02x\n",
		       s5kjn1_barley_common_data[idx],
		       s5kjn1_barley_common_data[idx + 1],
		       s5kjn1_barley_common_data[idx + 2],
		       s5kjn1_barley_common_data[idx + 3]);
}
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, s5kjn1_barley_common_data,
