 ...
 * Filename:
 * ---------
 *     gc32e2mipiraw_alphab5_Sensor.c
 *
 * Project:
 * --------
 *   ALPS
...
#include "gc32e2mipiraw_alphab5_Sensor.h"
...
#define DEVICE_VERSION_ALPHAB5_GC32E2    "gc32e2_alphab5"
static DEFINE_SPINLOCK(imgsensor_drv_lock);
static kal_uint8 otp_data[0x4000] = {0};

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC32E2_SENSOR_ID_ALPHAB5,
    .module_id = 0x01,
    ...
    .custom5 = {//3264*1632@60fps
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 331200000,//1600*4/10
        .max_framerate = 300,
    },
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_18_9 = {
    .i4OffsetX = 32,
    .i4OffsetY = 14,
    .i4PitchX = 8,
    .i4PitchY = 8,
...
static kal_uint32 return_sensor_id(void)
{
    ...
    sensor_id = ((read_cmos_sensor_8(0x03f0) << 8) | read_cmos_sensor_8(0x03f1)) + SENSOR_ID_OFFSET_ALPHAB5;
	printk("returning sensor_id, sensor_id: 0x%x, SENSOR_ID_OFFSET_ALPHAB5: 0x%x\n", sensor_id, SENSOR_ID_OFFSET_ALPHAB5);
    return sensor_id;
}
...
kal_uint16 gc32e2_alphab5_init_addr_data[] = {
    0x1320,0x01,
    0x1321,0x00,
    0x0315,0x80,
    0x0aff,0x00,
...
static void sensor_init(void)
{
    ...
    table_write_cmos_sensor(gc32e2_alphab5_init_addr_data,
        sizeof(gc32e2_alphab5_init_addr_data)/sizeof(kal_uint16));
    pr_debug("[%s] init_End\n", __func__);
}   /*    sensor_init  */
...
#define GC32E2_ALPHAB5_EEPROM_I2C_ADDR 0xA0
#define GC32E2_ECO_VALUE 3
static BYTE gc32e2_alphab5_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_gc32e2_alphab5_eeprom_module(kal_uint32 addr)
{
    kal_uint16 get_byte = 0;
    char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

    iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, GC32E2_ALPHAB5_EEPROM_I2C_ADDR);

    return get_byte;
}

static void read_gc32e2_alphab5_module_data()
{
    kal_uint16 idx = 0;
    ...
    memset(gc32e2_alphab5_common_data, 0,sizeof(gc32e2_alphab5_common_data));
    // QR
    for(idx = 0; idx < sn_length; idx++)
    {
        gc32e2_alphab5_common_data[8 + idx] = read_gc32e2_alphab5_eeprom_module(sn_starAddr + idx);
    }
    // vcm
    gc32e2_alphab5_common_data[40] = read_gc32e2_alphab5_eeprom_module(vcmAddr);
    gc32e2_alphab5_common_data[41] = read_gc32e2_alphab5_eeprom_module(vcmAddr + 1);
     // lensid
    gc32e2_alphab5_common_data[44] = read_gc32e2_alphab5_eeprom_module(lensAddr);
    gc32e2_alphab5_common_data[45] = read_gc32e2_alphab5_eeprom_module(lensAddr + 1);
    // macro
    gc32e2_alphab5_common_data[48] = read_gc32e2_alphab5_eeprom_module(macAddr_lsb);
    gc32e2_alphab5_common_data[49] = read_gc32e2_alphab5_eeprom_module(macAddr_msb);
    // inf
    gc32e2_alphab5_common_data[52] = read_gc32e2_alphab5_eeprom_module(infAddr_lsb);
    gc32e2_alphab5_common_data[53] = read_gc32e2_alphab5_eeprom_module(infAddr_msb);

    for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
        printk("cam data: %02x %02x %02x %02x\n",
               gc32e2_alphab5_common_data[idx],
               gc32e2_alphab5_common_data[idx + 1],
               gc32e2_alphab5_common_data[idx + 2],
               gc32e2_alphab5_common_data[idx + 3]);
}
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                if ((read_gc32e2_alphab5_eeprom_module(0x00)) == imgsensor_info.module_id) {
                    read_gc32e2_version();
                    if(deviceInfo_register_value == 0x00) {
                        register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_ALPHAB5_GC32E2, imgsensor_info.module_id);
                        read_gc32e2_alphab5_module_data();
                        if(otp_data[0] == 0) {
                            read_otp_info(otp_data);
                            gc32e2_alphab5_otp_identify();
                        } else {
...
/*************************PDAF START*************************/
    case SENSOR_FEATURE_GET_PDAF_INFO:
        ...
        case MSDK_SCENARIO_ID_CUSTOM4:
            ...
            break;
        case MSDK_SCENARIO_ID_CUSTOM5:
            memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_18_9,
                sizeof(struct SET_PD_BLOCK_INFO_T));
            break;
        case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
        case MSDK_SCENARIO_ID_SLIM_VIDEO:
...
/*************************PDAF END*************************/
    ...
    case SENSOR_FEATURE_GET_4CELL_DATA: /*get 4 cell data from eeprom*/
    {
        ...
        if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL)
            gc32e2_alphab5_copy_crosstalk_data(ct_data);
        break;
    }
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, gc32e2_alphab5_common_data,
