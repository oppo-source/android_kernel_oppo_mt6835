...
#include "ov50d40mipirawavatarb5_Sensor.h"
#include "ov50d40_Sensoravatarb5_setting.h"
...
#define DEVICE_VERSION_OV50D40_AVATARB5     "ov50d40_avaterb5"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_AVATARB5,
            ...
            if (*sensor_id == OV50D40_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(deviceInfo_register_value == 0x00) {
                    ...
                    register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_OV50D40_AVATARB5, imgsensor_info.module_id);
