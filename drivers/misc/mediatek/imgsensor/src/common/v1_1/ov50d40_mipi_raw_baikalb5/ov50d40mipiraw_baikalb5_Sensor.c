...
#include "ov50d40mipiraw_baikalb5_Sensor.h"
#include "ov50d40_Sensor_baikalb5_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_BAIKALB5,
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            ...
            pr_err("[get_imgsensor_id] OV50D40 sunny read sensor id fail, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
            i++;
        retry = 2;
