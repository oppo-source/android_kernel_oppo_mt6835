...
#include "sc202csmipiraw_chopard_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202cs_mipi_chopard"
...
#define DEVICE_VERSION_CHOPARD_SC202CS    "sc202cs"
static kal_uint8 deviceInfo_register_value = 0x00;

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC202CS_SENSOR_ID_CHOPARD,
			...
			*sensor_id = return_sensor_id();
            pr_err("cwd return_sensor_id:0x%x\n",*sensor_id);
             ...
             if (deviceInfo_register_value == 0x00) {
                    register_imgsensor_deviceinfo("Cam_r1", DEVICE_VERSION_CHOPARD_SC202CS, imgsensor_info.module_id);
