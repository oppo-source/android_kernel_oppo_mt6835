...
#include "ov13b10mipiraw_baikalb5_Sensor.h"
...
#define OV13B10_QT_EEPROM_I2C_ADDR 0xA0
#define OV13B10_BAIKALB5_EEPROM_I2C_ADDR 0xA0
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_SENSOR_ID_BAIKALB5,
	.module_id = 0x01,
...
kal_uint16 addr_data_pair_init_baikalb5_ov13b10[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
	...
	0x3817, 0x01,
	0x381f, 0x08,
	0x3820, 0x88,//0x3820[2] ISP Vertical flip  	0x3820[1] Sensor Vertical flip
	0x3821, 0x00,//0x3821[2] ISP Horizontal mirror  0x3821[1] Sensor Horizontal mirror
	0x3822, 0x04,
	0x382e, 0xe6,
	0x3c80, 0x00,
	0x3c87, 0x01,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_init_baikalb5_ov13b10,
			   sizeof(addr_data_pair_init_baikalb5_ov13b10) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_preview_baikalb5_ov13b10,
				   sizeof(addr_data_pair_preview_baikalb5_ov13b10) / sizeof(kal_uint16));
#endif
}	/*	preview_setting  */
/*************************************************************************
* FUNCTION
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_setting_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_setting_baikalb5_ov13b10,
		sizeof(addr_data_pair_capture_setting_baikalb5_ov13b10) /
		sizeof(kal_uint16));
#endif
}
...
kal_uint16 addr_data_pair_normal_video_setting_baikalb5_ov13b10[] = {
	0x0100, 0x00,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_normal_video_setting_baikalb5_ov13b10,
				   sizeof(addr_data_pair_normal_video_setting_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_slim_video_setting_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_slim_video_setting_baikalb5_ov13b10,
				   sizeof(addr_data_pair_slim_video_setting_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_hs_video_setting_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_hs_video_setting_baikalb5_ov13b10,
				   sizeof(addr_data_pair_hs_video_setting_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_custom1_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom1_setting(void)
{
	...
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom1_baikalb5_ov13b10,
				   sizeof(addr_data_pair_custom1_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
kal_uint16 addr_data_pair_custom2_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x4b,
	0x0327, 0x05,
...
static void custom2_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom2_baikalb5_ov13b10,
				   sizeof(addr_data_pair_custom2_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
kal_uint16 addr_data_pair_custom3_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom3_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom3_baikalb5_ov13b10,
				   sizeof(addr_data_pair_custom3_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}


kal_uint16 addr_data_pair_custom4_baikalb5_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom4_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom4_baikalb5_ov13b10,
				   sizeof(addr_data_pair_custom4_baikalb5_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
...
{
    char pusendcmd[2] = {(char)(addr >> 8), (char)(addr & 0xFF) };
    iReadRegI2C(pusendcmd, 2, (u8 *)table, size, OV13B10_BAIKALB5_EEPROM_I2C_ADDR);
}
...
static BYTE ov13b10_baikalb5_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };
static kal_uint16 read_ov13b10_baikalb5_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, OV13B10_BAIKALB5_EEPROM_I2C_ADDR);

	return get_byte;
}

static void read_ov13b10_baikalb5_module_data()
{
// ov13b10_baikalb5_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
	...
	memset(ov13b10_baikalb5_common_data, 0,sizeof(ov13b10_baikalb5_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ov13b10_baikalb5_common_data[8 + idx] = read_ov13b10_baikalb5_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	ov13b10_baikalb5_common_data[40] = read_ov13b10_baikalb5_eeprom_module(vcmAddr);
	ov13b10_baikalb5_common_data[41] = read_ov13b10_baikalb5_eeprom_module(vcmAddr + 1);
	//lensid
	ov13b10_baikalb5_common_data[44] = read_ov13b10_baikalb5_eeprom_module(lensAddr);
	ov13b10_baikalb5_common_data[45] = read_ov13b10_baikalb5_eeprom_module(lensAddr + 1);
	//macro
	ov13b10_baikalb5_common_data[48] = read_ov13b10_baikalb5_eeprom_module(macAddr);
	ov13b10_baikalb5_common_data[49] = read_ov13b10_baikalb5_eeprom_module(macAddr + 1);
	//inf
	ov13b10_baikalb5_common_data[52] = read_ov13b10_baikalb5_eeprom_module(infAddr);
	ov13b10_baikalb5_common_data[53] = read_ov13b10_baikalb5_eeprom_module(infAddr + 1);

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		LOG_INF("cam data: %02x %02x %02x %02x\n",
		       ov13b10_baikalb5_common_data[idx],
		       ov13b10_baikalb5_common_data[idx + 1],
		       ov13b10_baikalb5_common_data[idx + 2],
		       ov13b10_baikalb5_common_data[idx + 3]);
}
...
{
	return (((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c)) + SENSOR_ID_OFFSET_BAIKALB5);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	LOG_ERR("[ov13b10]get_imgsensor_id\n");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			/* lx_revised */
			LOG_ERR("[ov13b10]Read sensor id OK, write id:0x%x ,sensor Id:0x%x/0x%x\n",
				imgsensor.i2c_write_id, *sensor_id, imgsensor_info.sensor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
				if(deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION, imgsensor_info.module_id);
					read_ov13b10_baikalb5_module_data();
					deviceInfo_register_value = 0x05;
				}
				if (otp_data[0] == 0) {
					read_otp_info(otp_data);
				} else {
					LOG_ERR("otp data has already read");
				}
				LOG_ERR("BB5 OV13B 24362 i2c write id: 0x%x, sensor id: 0x%x\n",
									imgsensor.i2c_write_id, *sensor_id);
				/*Readout SN data*/
				return ERROR_NONE;
			}
			LOG_ERR("BB5 OV13B 24362 Read sensor id OK:0x%x, id: 0x%x\n", imgsensor.i2c_write_id,
				*sensor_id);
			retry--;
		} while (retry > 0);
		i++;
	...
	LOG_ERR("BB5 OV13B 24362 Read sensor sensor_id fail, id: 0x%x\n", *sensor_id);
	return ERROR_NONE;
}
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_ERR("[16885]i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id);
				break;
			}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ov13b10_baikalb5_common_data,
