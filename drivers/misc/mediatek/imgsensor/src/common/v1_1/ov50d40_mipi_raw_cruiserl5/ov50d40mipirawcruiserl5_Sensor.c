...
#include "ov50d40mipirawcruiserl5_Sensor.h"
#include "ov50d40_Sensorcruiserl5_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_CRUISERL5,
...
static kal_uint32 return_sensor_id(void)
{
    return (((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) |
              read_cmos_sensor(0x300c)) + SENSOR_ID_OFFSET_CRUISERL5);
}
