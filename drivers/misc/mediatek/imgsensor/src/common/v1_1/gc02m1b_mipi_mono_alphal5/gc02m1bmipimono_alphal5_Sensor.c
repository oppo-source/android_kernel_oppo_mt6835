 ...
 * Filename:
 * ---------
 *     gc02m1bmipimono_alphal5_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "gc02m1bmipimono_alphal5_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1B_SENSOR_ID_ALPHAL5,
...
{
	return (((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + SENSOR_ID_OFFSET_ALPHAL5);
}
