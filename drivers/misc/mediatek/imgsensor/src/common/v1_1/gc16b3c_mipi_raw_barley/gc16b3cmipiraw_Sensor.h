 ...
 * Filename:
 * ---------
 *     gc08a8mipiraw_avatarl5_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _GC16B3CMIPI_SENSOR_H
#define _GC16B3CMIPI_SENSOR_H
...
#define GC16B3C_MIRROR_NORMAL    1
#define GC16B3C_MIRROR_H         0
#define GC16B3C_MIRROR_V         0
#define GC16B3C_MIRROR_HV        0

#if GC16B3C_MIRROR_NORMAL
#define GC16B3C_MIRROR	        0x00
#elif GC16B3C_MIRROR_H
#define GC16B3C_MIRROR	        0x01
#elif GC16B3C_MIRROR_V
#define GC16B3C_MIRROR	        0x02
#elif GC16B3C_MIRROR_HV
#define GC16B3C_MIRROR	        0x03
#else
#define GC16B3C_MIRROR	        0x00
#endif
