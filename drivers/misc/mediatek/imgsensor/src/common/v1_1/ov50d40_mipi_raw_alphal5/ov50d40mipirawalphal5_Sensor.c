...
#include "ov50d40mipirawalphal5_Sensor.h"
#include "ov50d40_Sensoralphal5_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_ALPHAL5,
...
static kal_uint32 return_sensor_id(void)
{
    return (((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) |
              read_cmos_sensor(0x300c)) + SENSOR_ID_OFFSET_ALPHAL5);
}
            ...
            MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    if (scenario_id != MSDK_SCENARIO_ID_CUSTOM2 && videoGainDiffNormal == true) {
        videoGainDiffNormal = false;
    }
            ...
            UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    *(feature_data + 1) = imgsensor_info.min_shutter;
    ...
    case SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME:
        LOG_DBG("SENSOR_FEATURE_SET_SHUTTER_FRAME_TIME\n");
