...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10_SENSOR_ID_BARLEY,
	.module_id = 0x01,
...
kal_uint16 addr_data_pair_init_barley_ov13b10[] = {
	0x0103, 0x01,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0321, 0x00,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_init_barley_ov13b10,
			   sizeof(addr_data_pair_init_barley_ov13b10) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_preview_barley_ov13b10,
				   sizeof(addr_data_pair_preview_barley_ov13b10) / sizeof(kal_uint16));
#endif
}	/*	preview_setting  */
/*************************************************************************
* FUNCTION
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_setting_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov13b10_table_write_cmos_sensor(
		addr_data_pair_capture_setting_barley_ov13b10,
		sizeof(addr_data_pair_capture_setting_barley_ov13b10) /
		sizeof(kal_uint16));
#endif
}
...
kal_uint16 addr_data_pair_normal_video_setting_barley_ov13b10[] = {
	0x0100, 0x00,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_normal_video_setting_barley_ov13b10,
				   sizeof(addr_data_pair_normal_video_setting_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_slim_video_setting_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_slim_video_setting_barley_ov13b10,
				   sizeof(addr_data_pair_slim_video_setting_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_hs_video_setting_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x23,
	0x0327, 0x04,
...
{
	#if MULTI_WRITE
	ov13b10_table_write_cmos_sensor(addr_data_pair_hs_video_setting_barley_ov13b10,
				   sizeof(addr_data_pair_hs_video_setting_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_custom1_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom1_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom1_barley_ov13b10,
				   sizeof(addr_data_pair_custom1_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
kal_uint16 addr_data_pair_custom2_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x4b,
	0x0327, 0x05,
...
static void custom2_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom2_barley_ov13b10,
				   sizeof(addr_data_pair_custom2_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}
kal_uint16 addr_data_pair_custom3_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom3_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom3_barley_ov13b10,
				   sizeof(addr_data_pair_custom3_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}


kal_uint16 addr_data_pair_custom4_barley_ov13b10[] = {
	0x0100, 0x00,
	0x0303, 0x01,
	0x0305, 0x46,
	0x0327, 0x05,
...
static void custom4_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov13b10_table_write_cmos_sensor(addr_data_pair_custom4_barley_ov13b10,
				   sizeof(addr_data_pair_custom4_barley_ov13b10) /
				   sizeof(kal_uint16));
	#endif
}

#define OV13B10_BARLEY_EEPROM_I2C_ADDR 0xA0
static BYTE ov13b10_barley_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };
static kal_uint16 read_ov13b10_barley_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, OV13B10_BARLEY_EEPROM_I2C_ADDR);

	return get_byte;
}

static void read_ov13b10_barley_module_data()
{
// ov13b10_barley_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
	...
	memset(ov13b10_barley_common_data, 0,sizeof(ov13b10_barley_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ov13b10_barley_common_data[8 + idx] = read_ov13b10_barley_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	ov13b10_barley_common_data[40] = read_ov13b10_barley_eeprom_module(vcmAddr);
	ov13b10_barley_common_data[41] = read_ov13b10_barley_eeprom_module(vcmAddr + 1);
	//lensid
	ov13b10_barley_common_data[44] = read_ov13b10_barley_eeprom_module(lensAddr);
	ov13b10_barley_common_data[45] = read_ov13b10_barley_eeprom_module(lensAddr + 1);

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		LOG_INF("cam data: %02x %02x %02x %02x\n",
		       ov13b10_barley_common_data[idx],
		       ov13b10_barley_common_data[idx + 1],
		       ov13b10_barley_common_data[idx + 2],
		       ov13b10_barley_common_data[idx + 3]);
}
			...
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				if(deviceInfo_register_value == 0x00) {
				    ...
				    read_ov13b10_barley_module_data();
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ov13b10_barley_common_data,
