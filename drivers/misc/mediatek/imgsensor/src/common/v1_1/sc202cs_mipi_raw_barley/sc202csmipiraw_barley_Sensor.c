...
#include "sc202csmipiraw_barley_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202cs_mipi_barley"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC202CS_SENSOR_ID_BARLEY,
...
{
	return (((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108))+2); //0xeb15
}
