...
#include "sc202csmipiraw_rado_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202cs_mipi_rado"
...
#define DEVICE_VERSION_RADO_SC202CS    "sc202cs"
			...
			*sensor_id = return_sensor_id();
            pr_err("cwd return_sensor_id:0x%x\n",*sensor_id);
             ...
             if (deviceInfo_register_value == 0x00) {
                    register_imgsensor_deviceinfo("Cam_r1", DEVICE_VERSION_RADO_SC202CS, imgsensor_info.module_id);
