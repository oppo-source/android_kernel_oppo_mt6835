...
#include "ov08f10mipiraw_cruiserl5_Sensor.h"
#define EEPROM_WRITE_ID 0xA2
//#define OV08F10_ECO_VALUE 3
#define PFX "CRUISERL5_SHINETECH_FRONT_OV08F10_camera_sensor"
...
#define OV08F10_EEPROM_I2C_ADDR 0xA2
#define LEFT_SIZE (0x4000)
#define READ_EEPROM_1K (1024)
static kal_uint8 otp_data[LEFT_SIZE] = {0};
/* Camera Hardwareinfo */
#ifdef OPLUS_FEATURE_CAMERA_COMMON
//#define DEVICE_VERSION_OV08F10_CRUISERL5 "ov08f10mipiraw_cruiserl5_Sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV08F10_SENSOR_ID_CRUISERL5,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
	...
	{  3264, 2448,  0, 0, 3264, 2448, 3264, 2448,   0,   0,  3264, 2448,  0, 0, 3264, 2448},
	{  3264, 2448,  0, 0, 3264, 2448, 3264, 2448,   0,  306, 3264, 1836,  0, 0, 3264, 1836},
	{  3264, 2448,  0, 0, 3264, 2448, 1632, 1224,   0,   0,  1632, 1224,  0, 0, 1632, 1224},/*hs_video,don't use,same as custom1*/
	{  3264, 2448,  0, 0, 3264, 2448, 1632, 1224,   0,   0,  1632, 1224,  0, 0, 1632, 1224},/*slim video,same as custom1*/
	{  3264, 2448,  0, 0, 3264, 2448, 3264, 2448, 480,  360, 2304, 1728,  0, 0, 2304, 1728},/*custom1*/
	{  3264, 2448,  0, 0, 3264, 2448, 1632, 1224,   0,   0,  1632, 1224,  0, 0, 1632, 1224},/*custom2:binning size*/
};
...
/*static kal_uint32 read_OV08F10_version(void)
{
	  kal_uint32 ov08f10_version_value = 0;
	  ...
	  ov08f10_version_value = read_cmos_sensor(0x0e);
	  LOG_INF("read ov08f10 version 0x0e = %d\n", ov08f10_version_value);
	  return ov08f10_version_value;
}*/
...
static kal_uint32 return_sensor_id(void)
{
	...
	return (((read_cmos_sensor(0x00) << 24) | (read_cmos_sensor(0x01) << 16)
		| (read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03)) + 0x80);
}
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if((gain >= 0x40) && (gain <= (15.5*0x40))) //base gain = 0x40
	{
		...
		if(iReg<=0x10)
		{
			...
			write_cmos_sensor(0xfd, 0x01);	//page1
			write_cmos_sensor(0x01, 0x01);	//fresh
			LOG_INF("OV08F10MIPI_CRUISERL5_SetGain = 16");
		}
		else if(iReg>= 0xf8)//gpw
		{
			...
			write_cmos_sensor(0xfd, 0x01);	//page1
			write_cmos_sensor(0x01, 0x01);	//fresh
			LOG_INF("OV08F10MIPI_CRUISERL5_SetGain = 160");
		}
		else
		{
			write_cmos_sensor(0xfd, 0x01);
			...
			write_cmos_sensor(0xfd, 0x01);	//page1
			write_cmos_sensor(0x01, 0x01);	//fresh
			LOG_INF("OV08F10MIPI_CRUISERL5_SetGain = %d",iReg);
		}
	}
	else
...
static kal_uint16 cruiserl5_ov08f10_init_setting[] = {
	0xfd, 0x00,
};

static kal_uint16 cruiserl5_ov08f10_preview_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
static kal_uint16 cruiserl5_ov08f10_capture_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
static kal_uint16 cruiserl5_ov08f10_normal_video_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
static kal_uint16 cruiserl5_ov08f10_slim_video_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
static kal_uint16 cruiserl5_ov08f10_hs_video_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
static kal_uint16 cruiserl5_ov08f10_custom1_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
static kal_uint16 cruiserl5_ov08f10_custom2_setting[] =  {
	0x20, 0x0b,
	0xfd, 0x00,
	0xc2, 0x32,
	0x21, 0x07,
...
{
	table_write_cmos_sensor(cruiserl5_ov08f10_init_setting,
		sizeof(cruiserl5_ov08f10_init_setting) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_preview_setting,
		sizeof(cruiserl5_ov08f10_preview_setting) / sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_capture_setting,
		sizeof(cruiserl5_ov08f10_capture_setting) / sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_normal_video_setting,
		sizeof(cruiserl5_ov08f10_normal_video_setting) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_slim_video_setting,
		sizeof(cruiserl5_ov08f10_slim_video_setting) / sizeof(kal_uint16));
}
...
{	write_cmos_sensor(0xfd, 0x00);
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_hs_video_setting,
		sizeof(cruiserl5_ov08f10_hs_video_setting) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_custom1_setting,
		sizeof(cruiserl5_ov08f10_custom1_setting) / sizeof(kal_uint16));
}
static void custom2_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(cruiserl5_ov08f10_custom2_setting,
		sizeof(cruiserl5_ov08f10_custom2_setting) / sizeof(kal_uint16));
}
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define OV08F10_CRUISERL5_EEPROM_I2C_ADDR 0xA2
static BYTE ov08f10_cruiserl5_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_ov08f10_cruiserl5_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, OV08F10_CRUISERL5_EEPROM_I2C_ADDR);
...
static void read_ov08f10_cruiserl5_module_data()
{
// ov08f10_cruiserl5_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
	...
	memset(ov08f10_cruiserl5_common_data, 0,sizeof(ov08f10_cruiserl5_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ov08f10_cruiserl5_common_data[8 + idx] = read_ov08f10_cruiserl5_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	ov08f10_cruiserl5_common_data[40] = read_ov08f10_cruiserl5_eeprom_module(vcmAddr);
	ov08f10_cruiserl5_common_data[41] = read_ov08f10_cruiserl5_eeprom_module(vcmAddr + 1);
	//lensid
	ov08f10_cruiserl5_common_data[44] = read_ov08f10_cruiserl5_eeprom_module(lensAddr);
	ov08f10_cruiserl5_common_data[45] = read_ov08f10_cruiserl5_eeprom_module(lensAddr + 1);

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		LOG_ERR("cam data: %02x %02x %02x %02x\n",
		       ov08f10_cruiserl5_common_data[idx],
		       ov08f10_cruiserl5_common_data[idx + 1],
		       ov08f10_cruiserl5_common_data[idx + 2],
		       ov08f10_cruiserl5_common_data[idx + 3]);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		*sensor_id = return_sensor_id();
		LOG_INF("cruiserl5_WIDE_OV08F10 get_imgsensor_id : 0x%x\n", *sensor_id);
			if (*sensor_id == imgsensor_info.sensor_id) {
				//if ((read_OV08F10_version()) < OV08F10_ECO_VALUE) {
				//	*sensor_id = 0xFFFFFFFF;
				//	LOG_ERR("cruiserl5_FRONT_OV08F10 get_imgsensor_id failed: 0x%x\n", *sensor_id);
				//	return ERROR_SENSOR_CONNECT_FAIL;
				//} else {
					//Eeprom_DataInit(1, OV08F10_SENSOR_ID_CRUISERL5 );
					if(deviceInfo_register_value == 0x00) {
						register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION, imgsensor_info.module_id);
						read_ov08f10_cruiserl5_module_data();
				...
				LOG_INF("cruiserl5_WIDE_OV08F10 get_imgsensor_id success: 0x%x\n", *sensor_id);
				return ERROR_NONE;
				//}
			}
			retry--;
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		LOG_ERR("cruiserl5_WIDE_OV08F10 get_imgsensor_id failed: 0x%x\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	return ERROR_NONE;
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			LOG_INF("open() cruiserl5_WIDE_OV08F10 open imgsensor  : 0x%x\n", sensor_id);
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("cruiserl5_OV08F10 open success: 0x%x\n", sensor_id);
				break;
			}
			retry--;
		} while(retry > 0);
...
{
	pr_info("[cruiserl5_ov08f10] preview mode start\n");
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[cruiserl5_ov08f10] capture mode start\n");
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[cruiserl5_ov08f10] normal_video mode start\n");
...
static kal_uint32 hs_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[cruiserl5_ov08f10] hs_video mode start\n");
...
static kal_uint32 slim_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[cruiserl5_ov08f10] slim_video mode start\n");
...
static kal_uint32 custom1(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[cruiserl5_ov08f10] custom1 mode start\n");
...
static kal_uint32 custom2(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[cruiserl5_ov08f10] custom2 mode start\n");
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if(enable)
	{
		LOG_INF("ov08f10 enter pattern_mode enable");
		write_cmos_sensor(0xfd,0x01);
		...
		UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	/*case SENSOR_FEATURE_GET_SERIANO_IC:
		read_cruiserl5_ov08f10_QRSerialdata(feature_data_8, feature_para_len);
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ov08f10_cruiserl5_common_data,
