...
#include "sc520csmipiraw_baikalb5_Sensor.h"

#define LEFT_SIZE (0x4000)
#define SC520CS_EEPROM_I2C_ADDR 0xA0
#define DEVICE_VERSION_SC520CS_BAIKALB5 "sc520cs_baikalb5"
...
char g_baikalb5_otp_buf[3][MAX_EEPROM_BYTE] = {{0}, {0}, {0}};
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC520CS_SENSOR_ID_BAIKALB5,
	...
	.custom1 = {
		...
		.mipi_data_lp2hs_settle_dc = 14,
		.max_framerate = 300,
		.mipi_pixel_rate = 180000000,//900Mbps*2
	},
  	.exp_step = 2,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[6] = {
 ...
 { 2592, 1944,    0,  324, 2592, 1296, 2592, 1296, 0000, 0000, 2592, 1296,    0, 0, 2592, 1296},// custom1
};
#if MULTI_WRITE
...
{
	kal_uint32 sensor_id = ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108)) + SENSOR_ID_OFFSET_BAIKALB5;
...
static kal_uint16 avaterb5_sc520cs_normal_video_setting[] = {
	0x36e9,0x80,
	0x37f9,0x80,
	0x36ea,0x0e,
	0x36eb,0x0c,
...
static kal_uint16 avaterb5_sc520cs_2592x1296_setting[] = {
	0x36e9,0x80,
	0x37f9,0x80,
	0x36e9,0x23,
	0x37f9,0x23,
...
static void normal_video_setting(void)
{
	...
	write_cmos_sensor8(0x0103,0x01);
	mDELAY(10);
	sc520cs_table_write_cmos_sensor(avaterb5_sc520cs_normal_video_setting,
		sizeof(avaterb5_sc520cs_normal_video_setting) / sizeof(kal_uint16));
	if ((read_cmos_sensor(0x800B)&0xFF)==0)
	{
		write_cmos_sensor8(0x550F,0x42);
	}else {
...
{
	LOG_INF("[%s] 2592x1296_setting\n", __func__);
	write_cmos_sensor8(0x0103,0x01);
	mDELAY(10);
	sc520cs_table_write_cmos_sensor(avaterb5_sc520cs_2592x1296_setting,
		sizeof(avaterb5_sc520cs_2592x1296_setting) / sizeof(kal_uint16));
	if ((read_cmos_sensor(0x800B)&0xFF)==0)
	{
		write_cmos_sensor8(0x550F,0x42);
	}else {
...
int sc520cs_baikalb5_read_data(u16 addr, u8 *data);

OTP_MAP sc520cs_otp_map_baikalb5 = {
		.module_name = "SC520CS_BAIKALB5",
		.group_num = 3,
		.group_addr_info_num = 2,
		.readFunc = sc520cs_baikalb5_read_data,
		.group_info = {
						{"awb",
							{
...
static kal_uint16 read_sc520cs_baikalb5_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, SC520CS_EEPROM_I2C_ADDR);
...
static void read_sc520cs_module_data()
{
	...
	{
		sc520cs_common_data[8 + idx] = read_sc520cs_baikalb5_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	sc520cs_common_data[40] = read_sc520cs_baikalb5_eeprom_module(vcmAddr);
	sc520cs_common_data[41] = read_sc520cs_baikalb5_eeprom_module(vcmAddr + 1);
	//lensid
	sc520cs_common_data[44] = read_sc520cs_baikalb5_eeprom_module(lensAddr);
	sc520cs_common_data[45] = read_sc520cs_baikalb5_eeprom_module(lensAddr + 1);
...
char sub_baikalb5_camera_info[20] = {0};
EXPORT_SYMBOL(sub_baikalb5_camera_info);
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	LOG_INF("[sc520cs baikalb5 get_imgsensor_id] ");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
				*sensor_id =return_sensor_id();
				sprintf(sub_baikalb5_camera_info, "sc520cs");

				if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_INF("i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);

					if(deviceInfo_register_value == 0x00) {
						register_imgsensor_deviceinfo("Cam_f", DEVICE_VERSION_SC520CS_BAIKALB5, imgsensor_info.module_id);
