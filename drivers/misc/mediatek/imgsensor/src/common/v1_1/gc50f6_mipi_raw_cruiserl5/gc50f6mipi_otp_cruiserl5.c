...
#include "gc50f6mipi_otp_cruiserl5.h"

/****************************Modify Following Strings for Debug**************************/
#define PFX "GC50F6MIPI_OTP"
/****************************   Modify end    *******************************************/
#define GC50F6_OTP_DEBUG 1
#if GC50F6_OTP_DEBUG
...
void gc50f6_cruiserl5_read_crosstalk_data(void)
{
	kal_uint16 i = 0;
...
void gc50f6_cruiserl5_copy_crosstalk_data(kal_uint8 *ct_data)
{
...
void gc50f6_cruiserl5_otp_identify(void)
{
	LOG_INF("start hyper otp_identify");
	gc50f6_cruiserl5_read_crosstalk_data();
