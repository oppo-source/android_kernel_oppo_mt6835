...
#include "ov02b10mipiraw23281_Sensor.h"
...
#define OV02B10_MODULE_ID_ADDR 0x00
#define OV02B10_MODULE_ID 0x07
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV02B10_SENSOR_ID_23281,
...
static void read_ov02b10_module_data()
{
    ...
    kal_uint32 sn_starAddr = 0xE0;
    kal_uint32 lensAddr = 0x06;
    kal_uint32 vcmAddr = 0x07;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    module_id = read_eeprom_module(OV02B10_MODULE_ID_ADDR);
    if (module_id != OV02B10_MODULE_ID) {
        pr_info("[get_imgsensor_id] Ov02b10 Read module id fail, module_id = 0x%x\n", module_id);
        return ERROR_SENSOR_CONNECT_FAIL;
    } else {
        pr_info("[get_imgsensor_id] Ov02b10 Read module id sucess, module_id = 0x%x\n", module_id);
    }
