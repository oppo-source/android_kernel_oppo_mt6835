...
#include "sc202csmipiraw_baikalb5_Sensor.h"
#include "imgsensor_common.h"


/****************************Modify Following Strings for Debug****************************/
#define PFX "sc202cs_mipi_baikalb5"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC202CS_SENSOR_ID_BAIKALB5,
...
{
	return (((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108)) + SENSOR_ID_OFFSET_BAIKALB5);
}*/

static kal_uint32 return_sensor_id()
{
    kal_uint16 high_byte = read_cmos_sensor(0x3107);
    kal_uint16 low_byte = read_cmos_sensor(0x3108);
    kal_uint32 sensor_id = ((high_byte << 8) | low_byte) + SENSOR_ID_OFFSET_BAIKALB5;
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
    pr_err("SC202CS get_imgsensor_id \n");
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
			*sensor_id = return_sensor_id();
            pr_err("SC202CS return_sensor_id:0x%x\n",*sensor_id);
             if (*sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("SC202CS i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
