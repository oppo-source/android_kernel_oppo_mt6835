...
#define PFX "OV08D10_camera_sensor_avaterb5"
#define LOG_INF(format, args...)    \
	pr_debug(PFX "[%s] " format, __func__, ##args)
#define MULTI_WRITE 0
/* Camera Hardwareinfo */
#ifdef OPLUS_FEATURE_CAMERA_COMMON
//#define DEVICE_VERSION_OV08D10_avaterb5 "ov08d10mipiraw_avaterb5_Sensor"
...
#define DEVICE_VERSION  "ov08d10_avaterb5"
#define MODULE_ID_OFFSET 0x0000
//#endif
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV08D10_SENSOR_ID_AVATARB5,
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if((gain >= 0x40) && (gain <= (15.5*0x40))) //base gain = 0x40
	{
		...
		if(iReg<=0x10)
		{
			...
			write_cmos_sensor(0xfd, 0x01);	//page1
			write_cmos_sensor(0x01, 0x01);	//fresh
			LOG_INF("OV08D10MIPI_avaterb5_SetGain = 16");
		}
		else if(iReg>= 0xf8)//gpw
		{
			...
			write_cmos_sensor(0xfd, 0x01);	//page1
			write_cmos_sensor(0x01, 0x01);	//fresh
			LOG_INF("OV08D10MIPI_avaterb5_SetGain = 160");
		}
		else
		{
			write_cmos_sensor(0xfd, 0x01);
			...
			write_cmos_sensor(0xfd, 0x01);	//page1
			write_cmos_sensor(0x01, 0x01);	//fresh
			LOG_INF("OV08D10MIPI_avaterb5_SetGain = %d",iReg);
		}
	}
	else
...
static kal_uint16 avaterb5_ov08d10_init_setting[] = {
	0xfd, 0x00,
};

static kal_uint16 avaterb5_ov08d10_preview_setting[] = {
    #if 0
    // 1632x1224 settings
	0xfd, 0x00,
	0x20, 0x0e,
...
static kal_uint16 avaterb5_ov08d10_capture_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0x11, 0x2a,
	0x14, 0x43,
...
static kal_uint16 avaterb5_ov08d10_normal_video_setting[] = {
	0x20, 0x0b,
	0xfd, 0x00,
	0x11, 0x2a,
	0x14, 0x43,
...
static kal_uint16 avaterb5_ov08d10_slim_video_setting[] = {
	0x20, 0x0b,
	0x10, 0x05,
	0x11, 0x2a,
	0x12, 0x03,
...
static kal_uint16 avaterb5_ov08d10_hs_video_setting[] = {
	0x20, 0x0b,
	0x10, 0x05,
	0x11, 0x2a,
	0x12, 0x03,
...
static kal_uint16 avaterb5_ov08d10_custom1_setting[] = {
	0x20, 0x0b,
	0x10, 0x05,
	0x11, 0x2a,
	0x12, 0x03,
...
{
	table_write_cmos_sensor(avaterb5_ov08d10_init_setting,
		sizeof(avaterb5_ov08d10_init_setting) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	mdelay(3);
	table_write_cmos_sensor(avaterb5_ov08d10_preview_setting,
		sizeof(avaterb5_ov08d10_preview_setting) / sizeof(kal_uint16));
}
...
static void capture_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(avaterb5_ov08d10_capture_setting,
		sizeof(avaterb5_ov08d10_capture_setting) / sizeof(kal_uint16));
}
...
static void normal_video_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(avaterb5_ov08d10_normal_video_setting,
		sizeof(avaterb5_ov08d10_normal_video_setting) / sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(avaterb5_ov08d10_slim_video_setting,
		sizeof(avaterb5_ov08d10_slim_video_setting) / sizeof(kal_uint16));
}
...
{	write_cmos_sensor(0xfd, 0x00);
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(avaterb5_ov08d10_hs_video_setting,
		sizeof(avaterb5_ov08d10_hs_video_setting) / sizeof(kal_uint16));
}
...
static void custom1_setting(void)
{
	...
	write_cmos_sensor(0x20, 0x0e);
	mdelay(3);
	table_write_cmos_sensor(avaterb5_ov08d10_custom1_setting,
		sizeof(avaterb5_ov08d10_custom1_setting) / sizeof(kal_uint16));
}

//#ifdef OPLUS_FEATURE_CAMERA_COMMON
#define LEFT_SIZE (0x4000)
#define READ_EEPROM_1K (1024)
#define OV08D10_avaterb5_EEPROM_I2C_ADDR 0xA0
static kal_uint8 otp_data[LEFT_SIZE] = {0};
static BYTE ov08d10_avaterb5_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };
                                   ...
                                   kal_uint32 size)
{
    ...
    iReadRegI2C(pusendcmd, 2, (u8 *)table, size,
                OV08D10_avaterb5_EEPROM_I2C_ADDR);
}
...
static kal_uint16 read_ov08d10_avaterb5_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, OV08D10_avaterb5_EEPROM_I2C_ADDR);

	return get_byte;
}
static void read_ov08d10_avaterb5_module_data()
{
// ov08d10_avaterb5_common_data
// length   : 64
// QR       : [8 ~ 26]
// vcm      : [40 ~ 41]
// lensid   : [44 ~ 45]
// sensorid : [30 ~ 33]
	...
	memset(ov08d10_avaterb5_common_data, 0,sizeof(ov08d10_avaterb5_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ov08d10_avaterb5_common_data[8 + idx] = read_ov08d10_avaterb5_eeprom_module(sn_starAddr + idx);
	}
	//vcm
	ov08d10_avaterb5_common_data[40] = read_ov08d10_avaterb5_eeprom_module(vcmAddr);
	ov08d10_avaterb5_common_data[41] = read_ov08d10_avaterb5_eeprom_module(vcmAddr + 1);
	//lensid
	ov08d10_avaterb5_common_data[44] = read_ov08d10_avaterb5_eeprom_module(lensAddr);
	ov08d10_avaterb5_common_data[45] = read_ov08d10_avaterb5_eeprom_module(lensAddr + 1);

	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
		LOG_INF("cam data: %02x %02x %02x %02x\n",
		       ov08d10_avaterb5_common_data[idx],
		       ov08d10_avaterb5_common_data[idx + 1],
		       ov08d10_avaterb5_common_data[idx + 2],
		       ov08d10_avaterb5_common_data[idx + 3]);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		*sensor_id = return_sensor_id();
		printk("avaterb5_FRONT_OV08D10 get_imgsensor_id : 0x%x\n", *sensor_id);
		if (*sensor_id == imgsensor_info.sensor_id) {
			if ((read_OV08D10_version()) < OV08D10_ECO_VALUE) {
				*sensor_id = 0xFFFFFFFF;
				printk("avaterb5_FRONT_OV08D10 get_imgsensor_id failed: 0x%x\n", *sensor_id);
				return ERROR_SENSOR_CONNECT_FAIL;
			} else {
				//Eeprom_DataInit(1, OV08D10_SENSOR_ID_avaterb5 );
			    //imgsensor_info.module_id = read_ov08d10_avaterb5_eeprom_module(MODULE_ID_OFFSET);
			    if(deviceInfo_register_value == 0x00) {
					register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION, imgsensor_info.module_id);
					read_ov08d10_avaterb5_module_data();
				...
				LOG_INF("avaterb5_FRONT_OV08D10 get_imgsensor_id success: 0x%x\n", *sensor_id);
				return ERROR_NONE;
			}
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			sensor_id = return_sensor_id();
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("avaterb5_OV08D10 open success: 0x%x\n", sensor_id);
				break;
			}
			retry--;
		} while(retry > 0);
...
{
	pr_info("[avaterb5_ov08d10] preview mode start\n");
...
static kal_uint32 capture(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[avaterb5_ov08d10] capture mode start\n");
...
static kal_uint32 normal_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
		MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[avaterb5_ov08d10] normal_video mode start\n");
...
static kal_uint32 hs_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[avaterb5_ov08d10] hs_video mode start\n");
...
static kal_uint32 slim_video(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[avaterb5_ov08d10] slim_video mode start\n");
...
static kal_uint32 custom1(MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	pr_info("[avaterb5_ov08d10] custom1 mode start\n");
		...
		UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	/*case SENSOR_FEATURE_GET_SERIANO_IC:
		read_avaterb5_ov08d10_QRSerialdata(feature_data_8, feature_para_len);
...
//#ifdef OPLUS_FEATURE_CAMERA_COMMON
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ov08d10_avaterb5_common_data,
