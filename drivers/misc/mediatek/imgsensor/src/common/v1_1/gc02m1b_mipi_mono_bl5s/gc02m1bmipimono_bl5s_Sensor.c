 ...
 *============================================================================
 */
#define PFX "gc02m1b_camera_sensor_bl5s"
...
#include "gc02m1bmipimono_bl5s_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M1B_SENSOR_ID_BL5S,
...
{
	return (((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + SENSOR_ID_OFFSET_BL5S);
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	pr_err("GC02M1B return_sensor_id:0x%x\n",*sensor_id);
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_err("GC02M1B_bl5s i2c write id: 0x%x, GC02M1B sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
...
UINT32 GC02M1B_MIPI_MONO_BL5S_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
