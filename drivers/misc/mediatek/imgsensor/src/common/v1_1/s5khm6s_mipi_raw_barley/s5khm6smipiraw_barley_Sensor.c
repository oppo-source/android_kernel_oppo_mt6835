 ...
 * Filename:
 * ---------
 *     s5khm6smipiraw_barley_Sensor.c
 *
 * Project:
 * --------
 *     ALPS
...
#include "s5khm6smipiraw_barley_Sensor.h"
#include "s5khm6smipiraw_barley_setting.h"
...
#define DEVICE_VERSION_BARLEY_S5KHM6S    "s5khm6s"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = S5KHM6S_SENSOR_ID_BARLEY,
...
static void sensor_init(void)
{
    ...
    hm6_burst_write_cmos_sensor(addr_data_pair_barley_init_hm,
        sizeof(addr_data_pair_barley_init_hm) / sizeof(kal_uint16));
/*
    hm6_burst_write_cmos_sensor(addr_data_pair_barley_init_hm2,
        sizeof(addr_data_pair_barley_init_hm2) / sizeof(kal_uint16));

    write_cmos_sensor(0xfcfc, 0x2001);
    hm6_burst_write_cmos_sensor(addr_data_pair_barley_init_hm3,
        sizeof(addr_data_pair_barley_init_hm3) / sizeof(kal_uint16));

    table_write_cmos_sensor(addr_data_pair_barley_init_hm4,
        sizeof(addr_data_pair_barley_init_hm4) / sizeof(kal_uint16));
*/
    if(isDisableWriteInsensorZoomSetting == KAL_FALSE) {
        LOG_INF("s5khm6sp insensor zoom--- E\n");
        hm6_burst_write_cmos_sensor(addr_data_pair_barley_init_hm_insensorzoom,
            sizeof(addr_data_pair_barley_init_hm_insensorzoom) / sizeof(kal_uint16));

        LOG_INF("s5khm6sp insensor zoom--- X\n");
    }

    LOG_INF("s5khm6sp--- init X\n");
}
...
static void otp_sensor_init(void)
{
    ...
    table_write_cmos_sensor(addr_data_pair_barley_init_hm6_otp_sensor_1,
        sizeof(addr_data_pair_barley_init_hm6_otp_sensor_1) / sizeof(kal_uint16));

    if(isDisableWriteInsensorZoomSetting == KAL_FALSE) {
        table_write_cmos_sensor(addr_data_pair_barley_init_hm6_otp_sensor_2,
        sizeof(addr_data_pair_barley_init_hm6_otp_sensor_2) / sizeof(kal_uint16));

        hm6_burst_write_cmos_sensor(addr_data_pair_barley_init_hm6_otp_sensor_3,
            sizeof(addr_data_pair_barley_init_hm6_otp_sensor_3) / sizeof(kal_uint16));

        hm6_burst_write_cmos_sensor(addr_data_pair_barley_init_hm6_otp_sensor_4,
            sizeof(addr_data_pair_barley_init_hm6_otp_sensor_4) / sizeof(kal_uint16));
...
static void preview_setting(void)
{
    ...
    if (is_otp_sensor) {
        table_write_cmos_sensor(addr_data_pair_barley_pre2_otp_sensor,
            sizeof(addr_data_pair_barley_pre2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_pre_hm2,
            sizeof(addr_data_pair_barley_pre_hm2) / sizeof(kal_uint16));
    }
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    if (is_otp_sensor) {
        table_write_cmos_sensor(addr_data_pair_barley_cap_hm2_otp_sensor,
            sizeof(addr_data_pair_barley_cap_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_cap_hm2,
            sizeof(addr_data_pair_barley_cap_hm2) / sizeof(kal_uint16));
    }
...
static void normal_video_setting(void)
{
    LOG_INF("E\n");
    if (is_otp_sensor) {
        table_write_cmos_sensor(addr_data_pair_barley_video_hm2_otp_sensor,
        sizeof(addr_data_pair_barley_video_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_video_hm2,
            sizeof(addr_data_pair_barley_video_hm2) / sizeof(kal_uint16));
    }
}
...
static void hs_video_setting(void)
{
    LOG_INF("E\n");
    if (is_otp_sensor) {
            table_write_cmos_sensor(addr_data_pair_barley_hs_hm2_otp_sensor,
                sizeof(addr_data_pair_barley_hs_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_hs_hm2,
            sizeof(addr_data_pair_barley_hs_hm2) / sizeof(kal_uint16));
    }
}
...
static void slim_video_setting(void)
{
    LOG_INF("E\n");
    if (is_otp_sensor) {
            table_write_cmos_sensor(addr_data_pair_barley_slim_hm2_otp_sensor,
                sizeof(addr_data_pair_barley_slim_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
            table_write_cmos_sensor(addr_data_pair_barley_slim_hm2,
        sizeof(addr_data_pair_barley_slim_hm2) / sizeof(kal_uint16));
    }
...
static void custom1_setting(void)
{
    ...
    if (is_otp_sensor) {
            ...
            table_write_cmos_sensor(addr_data_pair_barley_cus1_hm2,
                sizeof(addr_data_pair_barley_cus1_hm2) / sizeof(kal_uint16));
    }
}
...
static void custom2_setting(void)
{
    LOG_INF("E\n");
    if (is_otp_sensor) {
        table_write_cmos_sensor(addr_data_pair_barley_cus2_hm2_otp_sensor,
            sizeof(addr_data_pair_barley_cus2_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_cus2_hm2,
            sizeof(addr_data_pair_barley_cus2_hm2) / sizeof(kal_uint16));
    }
}
...
static void custom3_setting(void)
{
    LOG_INF("E\n");
    if (is_otp_sensor) {
        table_write_cmos_sensor(addr_data_pair_barley_cus3_hm2_otp_sensor,
            sizeof(addr_data_pair_barley_cus3_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_cus3_hm2,
            sizeof(addr_data_pair_barley_cus3_hm2) / sizeof(kal_uint16));
    }
}
...
static void custom4_setting(void)
{
    LOG_INF("E\n");
    if (is_otp_sensor) {
        table_write_cmos_sensor(addr_data_pair_barley_cus4_hm2_otp_sensor,
            sizeof(addr_data_pair_barley_cus4_hm2_otp_sensor) / sizeof(kal_uint16));
    } else {
        table_write_cmos_sensor(addr_data_pair_barley_cus4_hm2,
            sizeof(addr_data_pair_barley_cus4_hm2) / sizeof(kal_uint16));
    }
}
...
{
    LOG_INF("E\n");
    table_write_cmos_sensor(addr_data_pair_barley_cus5_hm2,
        sizeof(addr_data_pair_barley_cus5_hm2) / sizeof(kal_uint16));
}

#define S5KHM6D_BARLEY_EEPROM_I2C_ADDR 0xA0
static BYTE s5khm6s_barley_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_s5khm6s_barley_eeprom_module(kal_uint32 addr)
{
    kal_uint16 get_byte = 0;
    char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

    iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, S5KHM6D_BARLEY_EEPROM_I2C_ADDR);

    return get_byte;
}

static void read_s5khm6s_barley_module_data(UINT32 sensor_id)
{
    kal_uint16 idx = 0;
    ...
    memset(s5khm6s_barley_common_data, 0,sizeof(s5khm6s_barley_common_data));
    // QR
    for(idx = 0; idx < sn_length; idx++)
    {
        s5khm6s_barley_common_data[8 + idx] = read_s5khm6s_barley_eeprom_module(sn_starAddr + idx);
    }
    // vcm
    s5khm6s_barley_common_data[40] = read_s5khm6s_barley_eeprom_module(vcmAddr);
     s5khm6s_barley_common_data[41] = read_s5khm6s_barley_eeprom_module(vcmAddr + 1);
     // lensid
    s5khm6s_barley_common_data[44] = read_s5khm6s_barley_eeprom_module(lensAddr);
    s5khm6s_barley_common_data[45] = read_s5khm6s_barley_eeprom_module(lensAddr + 1);
    // macro
    s5khm6s_barley_common_data[48] = read_s5khm6s_barley_eeprom_module(macAddr_lsb);
    s5khm6s_barley_common_data[49] = read_s5khm6s_barley_eeprom_module(macAddr_msb);
    // inf
    s5khm6s_barley_common_data[52] = read_s5khm6s_barley_eeprom_module(infAddr_lsb);
    s5khm6s_barley_common_data[53] = read_s5khm6s_barley_eeprom_module(infAddr_msb);
    // sensor id
    s5khm6s_barley_common_data[30] = ((sensor_id) >> 24) & 0xff;
    s5khm6s_barley_common_data[31] = ((sensor_id) >> 16) & 0xff;
    s5khm6s_barley_common_data[32] = ((sensor_id) >> 8) & 0xff;
    s5khm6s_barley_common_data[33] = (sensor_id) & 0xff;

    for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
        LOG_INF("cam data: %02x %02x %02x %02x\n",
               s5khm6s_barley_common_data[idx],
               s5khm6s_barley_common_data[idx + 1],
               s5khm6s_barley_common_data[idx + 2],
               s5khm6s_barley_common_data[idx + 3]);
}
            ...
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if (deviceInfo_register_value == 0x00) {
                    register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_BARLEY_S5KHM6S, module_id);
                    read_s5khm6s_barley_module_data(*sensor_id);
                        ...
                        MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    break;
    case MSDK_SCENARIO_ID_CUSTOM5:
        LOG_INF("%s insensorzoom MSDK_SCENARIO_ID_CUSTOM5 = %d",
                __func__, MSDK_SCENARIO_ID_CUSTOM5);
...
//        LOG_INF("shy printk insensorzoom SENSOR_FEATURE_SEAMLESS_SWITCH 3141 feature_id = %d\n", SENSOR_FEATURE_SEAMLESS_SWITCH);
    switch (feature_id) {
...
/*    case SENSOR_FEATURE_GET_EEPROM_DATA:
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2160000;// -1,823,000
        break;
...
// #ifdef OPLUS_FEATURE_CAMERA_COMMON
    ...
    case SENSOR_FEATURE_GET_EEPROM_COMDATA:
        memcpy(feature_return_para_32, s5khm6s_barley_common_data,
...
static kal_uint32 seamless_switch(enum MSDK_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case MSDK_SCENARIO_ID_CUSTOM5:
    {
        ...
        LOG_INF("%s MSDK_SCENARIO_ID_CUSTOM5 = %d, 0x0B30=0x%x",__func__, scenario_id,read_cmos_sensor(0x0B30));
        LOG_INF("%s MSDK_SCENARIO_ID_CUSTOM5 = %d, 0x0B31=0x%x",__func__, scenario_id,read_cmos_sensor(0x0B31));
        LOG_INF("%s MSDK_SCENARIO_ID_CUSTOM5 = %d, 0x0342=0x%x",__func__, scenario_id,read_cmos_sensor(0x0342));
        LOG_INF("%s MSDK_SCENARIO_ID_CUSTOM5 = %d, 0x0343=0x%x",__func__, scenario_id,read_cmos_sensor(0x0343));
        if (ae_ctrl) {
    ...
    case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
    {
        ...
        LOG_INF("%s MSDK_SCENARIO_ID_CAMERA_PREVIEW = %d, 0x0B30=0x%x",__func__, scenario_id,read_cmos_sensor(0x0B30));
        LOG_INF("%s MSDK_SCENARIO_ID_CAMERA_PREVIEW = %d, 0x0B31=0x%x",__func__, scenario_id,read_cmos_sensor(0x0B31));
        LOG_INF("%s MSDK_SCENARIO_ID_CAMERA_PREVIEW = %d, 0x0342=0x%x",__func__, scenario_id,read_cmos_sensor(0x0342));
        LOG_INF("%s MSDK_SCENARIO_ID_CAMERA_PREVIEW = %d, 0x0343=0x%x",__func__, scenario_id,read_cmos_sensor(0x0343));
        if (ae_ctrl) {
