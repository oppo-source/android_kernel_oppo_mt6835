...
#include "sc820csmipiraw_barley_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SC820CS_SENSOR_ID_BARLEY,
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor8(0x4819,0x14);
    write_cmos_sensor8(0x481b,0x0b);
    write_cmos_sensor8(0x481d,0x2c);
    write_cmos_sensor8(0x481f,0x09);
    write_cmos_sensor8(0x4821,0x11);
    write_cmos_sensor8(0x4823,0x0a);
    write_cmos_sensor8(0x4825,0x09);
    write_cmos_sensor8(0x4827,0x09);
    write_cmos_sensor8(0x4829,0x11);
...
#define SC820CS_BARLEY_EEPROM_I2C_ADDR 0xA8
static BYTE sc820cs_barley_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };

static kal_uint16 read_sc820cs_barley_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };

	iReadRegI2C(pusendcmd, 2, (u8 *) &get_byte, 1, SC820CS_BARLEY_EEPROM_I2C_ADDR);
