...
#include "gc50f6mipi_otp_mumbai.h"
...
void gc50f6_mumbai_read_crosstalk_data(void)
{
	kal_uint16 i = 0;
...
void gc50f6_mumbai_copy_crosstalk_data(kal_uint8 *ct_data)
{
...
void gc50f6_mumbai_otp_identify(void)
{
	LOG_INF("start hyper otp_identify");
	gc50f6_mumbai_read_crosstalk_data();
