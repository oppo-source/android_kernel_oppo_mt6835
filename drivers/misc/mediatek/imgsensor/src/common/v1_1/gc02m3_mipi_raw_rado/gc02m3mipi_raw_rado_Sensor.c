...
#include "gc02m3mipi_raw_rado_Sensor.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);


static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC02M3_SENSOR_ID_RADO,
...
static kal_uint16 gc02m3_custom1_addr_data[] = {
	0x031c, 0x84,
	0x0801, 0x0c,
	0x0e93, 0xc4,
	0x03e0, 0x0a,
...
{
	pr_debug("[%s] custom1_Start, 1600x1200@24fps\n", __func__);
	table_write_cmos_sensor(gc02m3_custom1_addr_data,
		sizeof(gc02m3_custom1_addr_data)/sizeof(kal_uint16));
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc02m3_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
