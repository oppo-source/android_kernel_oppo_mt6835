...
#include "fov50d40mipiraw_chopardf_Sensor.h"
#include "fov50d40_Sensor_chopardf_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = FOV50D40_SENSOR_ID_CHOPARDF,
    ...
    .custom6 = {
        .pclk = 100000000, /*3264x1856@30fps*/
        .linelength = 850,
        .framelength = 5880,
        .startx = 0,
        .starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[12] = {
	...
	{ 8192,  6144, 256, 1216,  7680,  3712,  3840,  1856,  0000,  0000,  3840,  1856,  0,  0,  3264,  1856}, /*custom6 */
};
