...
#include "gc50f6mipi_otp_mumbaif.h"
...
void gc50f6d_mumbaif_read_crosstalk_data(void)
{
	kal_uint16 i = 0;
...
void gc50f6d_mumbaif_copy_crosstalk_data(kal_uint8 *ct_data)
{
...
void gc50f6d_mumbaif_otp_identify(void)
{
	LOG_INF("start hyper otp_identify");
	gc50f6d_mumbaif_read_crosstalk_data();
