 ...
 * Filename:
 * ---------
 *     gc50f6mipiraw_mumbaif_Sensor.h
 *
 * Project:
 * --------
 *     ALPS
 ...
 *
 ****************************************************************************/
#ifndef _GC50F6MIPI_MUMBAIF_SENSOR_H
#define _GC50F6MIPI_MUMBAIF_SENSOR_H
...
extern void gc50f6d_mumbaif_copy_crosstalk_data(kal_uint8 *ct_data);
extern void gc50f6d_mumbaif_otp_identify(void);
