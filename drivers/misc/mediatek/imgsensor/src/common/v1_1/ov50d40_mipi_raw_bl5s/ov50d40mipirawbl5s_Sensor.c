...
#define PFX "OV50D40_camera_sensor_bl5s"
...
#include "ov50d40mipirawbl5s_Sensor.h"
#include "ov50d40_Sensorbl5s_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_BL5S,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
	...
	{ 8192,  6144,  0, 768,  8192,  4608,  4096,  2304,  0,  0,  4096,  2304,  0,  0,  4096,  2304},	/*normal video*/
	{ 8192,  6144, 256, 912,  7680,  4320,  1280,  720,  0,  0,  1280,  720,   0,  0,  1280,  720},	/*hs video*/
	{ 8192,  6144,  0, 768,  8192,  4608,  4096,  2304,  0,  0,  4096,  2304,  0,  0,  4096,  2304},	/*slim video*/
	{ 8192,  6144,  0,   0,  8192,  6144,  4096,  3072,  0,  0,  4096,  3072,  0,  0,  4096,  3072},	/*custom1 DualCam */
	{ 8192,  6144, 256, 912, 7680,  4320,  3840,  2160,  0,  0,  3840,  2160,  0,  0,  3840,  2160},	/*custom2 video 60fps*/
	{ 8192,  6144,  0, 1024, 8192,  4096,  4096,  2048,  0,  0,  4096,  2048,  0,  0,  4096,  2048},	/*custom3 18:9*/
};
...
static kal_uint32 return_sensor_id(void)
{
    return (((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) |
              read_cmos_sensor(0x300c)) + SENSOR_ID_OFFSET_BL5S);
}
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                pr_err("[get_imgsensor_id] OV50D40_bl5s Read sensor id Success, write id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
...
UINT32 OV50D40_MIPI_RAW_BL5S_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
