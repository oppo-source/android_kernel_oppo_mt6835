...
#include "ov50d40mipiraw_mumbai_Sensor.h"
#include "ov50d40_Sensor_mumbai_setting.h"
...
#define OV50D40_EEPROM_I2C_ADDR 0xA8
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV50D40_SENSOR_ID_MUMBAI,
    ...
    .custom5 = {
        .pclk = 100000000, /*2048x1536@30fps*/
        .linelength = 850,
        .framelength = 3920,
        .startx = 0,
        .starty = 0,
    ...
    .custom6 = {
        .pclk = 100000000, /*2048x1152@30fps*/
        .linelength = 850,
        .framelength = 3920,
        .startx = 0,
        .starty = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[11] = {
	...
	{ 8192,  6144,   0,   0,  8192,  6144,  2048,  1536,  0000,  0000,  2048,  1536,  0,  0,  2048,  1536}, /*custom5 */
	{ 8192,  6144,   0,  768, 8192,  4608,  2048,  1152,  0000,  0000,  2048,  1152,  0,  0,  2048,  1152,}, /*custom6 */
};
            ...
            UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    *(feature_data + 1) = imgsensor_info.min_shutter;
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MINT32 *)(signed long)(*(feature_data + 1)) = 950000;
        break;
#endif
