...
#include "ov50c40mipiraw_23706_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV50C40_SENSOR_ID_23706,
	.module_id = 0x01,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
    {8224, 6168,    32,   12, 8160, 6144, 4080, 3072,  0, 0, 4080, 3072, 0,  0,   4080, 3072},// Preview
    {8224, 6168,    32,   12, 8160, 6144, 4080, 3072,  0, 0, 4080, 3072, 0,  0,   4080, 3072},//capture
    {8224, 6168,   272,  924, 7680, 4320, 3840, 2160,  0, 0, 3840, 2160, 0,  0,   3840, 2160},//normal-video
    {8224, 6168,   272,  924, 7680, 4320, 3840, 2160,  0, 0, 1920, 1080, 0,  0,   1920, 1080},//hs-video 1920 1080
    {8224, 6168,  1792, 1348, 4640, 3472, 2320, 1736,  0, 0, 2320, 1736, 0,  0,   2320, 1736},//slim-video
    {8224, 6168,    48,   36, 8128, 6096, 4064, 3048,  0, 0, 4060, 3048, 0,  0,   4064, 3048},//custom1
    {8224, 6168,   272,  924, 7680, 4320, 3840, 2160,  0, 0, 1920, 1080, 0,  0,   1920, 1080},//custom2
    {8224, 6168,    32,   12, 8160, 6144, 4080, 3072,  0, 0, 4080, 3072, 0,  0,   4080, 3072},//custom3
    {8224, 6168,    32,   12, 8160, 6144, 4080, 3072,  0, 0, 4080, 3072, 0,  0,   4080, 3072},//custom4
    {8224, 6168,  848,   636, 6528, 4896, 3264, 2448,  0, 0, 3264, 2448, 0,  0,   3264, 2448},//custom5
};
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[7] = {
    ...
    },
    {
        ...
        0x01, 0x2b, 0x0330, 0x0264, 0x03, 0x00, 0x0000, 0x0000
    },
};
/*PDAF START*/
...
kal_uint16 addr_data_pair_init_23706_ov50c40[] = {
	0x0103,0x01,
	0x0301,0xc8,
	0x0304,0x01,
	0x0305,0x77,
...
static void sensor_init(void)
{
	...
	ov50c40_table_write_cmos_sensor(addr_data_pair_init_23706_ov50c40,
			   sizeof(addr_data_pair_init_23706_ov50c40) / sizeof(kal_uint16));
#endif
}
/*************************************************************************
* FUNCTION
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_23706_ov50c40[] = {
	0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void preview_setting(void)
{
	...
	ov50c40_table_write_cmos_sensor(addr_data_pair_preview_23706_ov50c40,
				   sizeof(addr_data_pair_preview_23706_ov50c40) / sizeof(kal_uint16));
#endif
}	/*	preview_setting  */
/*************************************************************************
* FUNCTION
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_setting_23706_ov50c40[] = {
		0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov50c40_table_write_cmos_sensor(
		addr_data_pair_capture_setting_23706_ov50c40,
		sizeof(addr_data_pair_capture_setting_23706_ov50c40) /
		sizeof(kal_uint16));
#endif
}
...
kal_uint16 addr_data_pair_normal_video_setting_23706_ov50c40[] = {
	0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void normal_video_setting(void)
{
	...
	ov50c40_table_write_cmos_sensor(addr_data_pair_normal_video_setting_23706_ov50c40,
				   sizeof(addr_data_pair_normal_video_setting_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_slim_video_setting_23706_ov50c40[] = {
	0x3607,0x00,
	0x3608,0xb2,
	0x360c,0x0b,
	0x360e,0x1e,
...
{
	#if MULTI_WRITE
	ov50c40_table_write_cmos_sensor(addr_data_pair_slim_video_setting_23706_ov50c40,
				   sizeof(addr_data_pair_slim_video_setting_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_hs_video_setting_23706_ov50c40[] = {
	0x3607,0x00,
	0x3608,0xb2,
	0x360c,0x0b,
	0x360e,0x1e,
...
{
	#if MULTI_WRITE
	ov50c40_table_write_cmos_sensor(addr_data_pair_hs_video_setting_23706_ov50c40,
				   sizeof(addr_data_pair_hs_video_setting_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
...
kal_uint16 addr_data_pair_custom1_23706_ov50c40[] = {
	0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void custom1_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov50c40_table_write_cmos_sensor(addr_data_pair_custom1_23706_ov50c40,
				   sizeof(addr_data_pair_custom1_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
}

kal_uint16 addr_data_pair_custom2_23706_ov50c40[] = {
	0x3607,0x00,
	0x3608,0xb2,
	0x360c,0x0b,
	0x360e,0x1e,
...
static void custom2_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov50c40_table_write_cmos_sensor(addr_data_pair_custom2_23706_ov50c40,
				   sizeof(addr_data_pair_custom2_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
}

kal_uint16 addr_data_pair_custom3_23706_ov50c40[] = {
	0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void custom3_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov50c40_table_write_cmos_sensor(addr_data_pair_custom3_23706_ov50c40,
				   sizeof(addr_data_pair_custom3_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
}

kal_uint16 addr_data_pair_custom4_23706_ov50c40[] = {
	0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void custom4_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov50c40_table_write_cmos_sensor(addr_data_pair_custom4_23706_ov50c40,
				   sizeof(addr_data_pair_custom4_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
}

kal_uint16 addr_data_pair_custom5_23706_ov50c40[] = {
	0x3607,0x01,
	0x3608,0xda,
	0x360c,0x03,
	0x360e,0x1d,
...
static void custom5_setting(void)
{
	#if MULTI_WRITE
	LOG_INF("E\n");
	ov50c40_table_write_cmos_sensor(addr_data_pair_custom5_23706_ov50c40,
				   sizeof(addr_data_pair_custom5_23706_ov50c40) /
				   sizeof(kal_uint16));
	#endif
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			/* lx_revised */
			printk("[ov50c40 23706]Read sensor id OK, write id:0x%x ,sensor Id:0x%x\n",
...
/*	case SENSOR_FEATURE_SET_STREAMING_SUSPEND:
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		case MSDK_SCENARIO_ID_CUSTOM1:
			...
			break;
		case MSDK_SCENARIO_ID_CUSTOM5:
			memcpy((void *)PDAFinfo, (void *)&imgsensor_pd_info_custom2,
				sizeof(struct SET_PD_BLOCK_INFO_T));
			break;
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
