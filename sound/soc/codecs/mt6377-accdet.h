...
#ifndef __MT6377_ACCDET_H__
#define __MT6377_ACCDET_H__
...
struct head_dts_data {
	...
	unsigned int hp_eint0_disable;
	unsigned int hp_plug_in_check;
};
...
extern void mt6377_accdet_late_init(unsigned long data);
extern void accdet_set_debounce(int state, unsigned int debounce);
extern void mt6377_accdet_modify_vref_volt(void);
extern int mt6377_accdet_init(struct snd_soc_component *component, struct snd_soc_card *card);
#endif /* __MT6377_ACCDET_H__ */
