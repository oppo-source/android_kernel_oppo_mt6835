			 ...
			 int id, snd_pcm_format_t format)
{
	...
	#if IS_ENABLED(CONFIG_SND_SOC_MT6835) && IS_ENABLED(CONFIG_SND_SOC_SIA91XX_V3_1_0)
	if (id == 21 /*MT6835_MEMIF_AWB2*/) {
		dev_info(afe->dev, "%s() AFE_AWB2_CON0 0x0878 bit4 set 1 for IV format\n",
				__func__);
		hd_align = 1;
	}
	#endif
