...
#else
		/* we don't have precise basepages LRU size, assume half is hugepage */
		lrusize = lruvec_page_state(lruvec, NR_INACTIVE_ANON) /2 +
			  lruvec_page_state(lruvec, NR_ACTIVE_ANON) / 2 +
			  lruvec_page_state(lruvec, NR_INACTIVE_FILE) +
			  lruvec_page_state(lruvec, NR_ACTIVE_FILE);
#endif
